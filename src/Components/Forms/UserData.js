...
export const UserData = (props) => {
    ...
    return(
        <FormControl as='div' w={props.w} isInvalid={errorName}>
            ...
            <Input data-testid='UserData-input' required maxW={props.width} placeholder={props.title} value={name} onChange={(e)=>setName(e.target.value)} onBlur={()=>touchName(true)} project='project'  name={props.name}  />
