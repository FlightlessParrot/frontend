...
const QuestionsSettings = lazy(() => import("./Pages/User/Tests/QuestionsSettings"));
const CreateTestInstance = lazy(() => import("./Pages/User/Tests/CreateTestInstance"));
...
const AdminFlashcards = lazy(() => import("./Pages/Admin/Flashcards/Flashcards"));
...
const AfterUserChoseTeam=lazy(()=>import("./Pages/Teacher/Modify/AfterUserChoseTeam"))
const Egzams = lazy(()=>import("./Pages/Teacher/Egzams"))
const Notyfications = lazy(()=>import("./Pages/User/Notyfications"))
const OpenQuestionCheck = lazy(()=>import("./Pages/Teacher/OpenQuestionCheck"))
const ChooseEgzamSettings = lazy(()=>import("./Pages/Teacher/ChooseEgzamSettings"))
const CreateOpenQuestion = lazy(()=>import("./Pages/Teacher/CreateOpenQuestion"))
...
const QuestionStatistics = lazy(()=>import("./Components/Statistics/QuestionStatistics"))
const TestReview = lazy(()=>import("./Pages/User/Tests/TestReview"))
const Handbook = lazy(()=>import("./Pages/Teacher/Handbook/Handbook"))
const ModifyHandbooks=lazy(()=>import("./Pages/Teacher/Handbook/ModifyHandbooks"))
const Statistics = lazy(()=>import("./Pages/User/Statistics"))
const TestSummary = lazy(()=>import("./Pages/User/TestSummary"));
const TestStatistics =lazy(()=>import("./Components/Statistics/TestStatistics"))
...
const AfterCreation=lazy(()=>import("./Pages/User/Tests/Settings/AfterCreation"))
const Subscriptions=lazy(()=>import("./Pages/Settings/Subscriptions"))
const ManageTests=lazy(()=>import("./Pages/Admin/Tests/ManageTests"))
const AdminTestSettings=lazy(()=>import("./Pages/Admin/Tests/AdminTestSettings"))
...
const DeleteCategory=lazy(()=>import("./Pages/Admin/Categories/DeleteCategory"))
const CreateFlashcard=lazy(()=>import("./Pages/Admin/Flashcards/CreateFlashcard"))
const UpdateAndDeleteSubscription=lazy(()=>import("./Pages/Admin/Subscriptions/UpdateAndDeleteSubscription"))
...
const DeleteFlashcards=lazy(()=>import("./Pages/Admin/Flashcards/DeleteFlashcards"))
...
const router = createBrowserRouter([
  ...
  {
    path: "/test",
    element: <Suspense fallback={<Loading />}><QuestionsSettings /></Suspense>,
  },
  {
    path: "/",
    element: <Suspense fallback={<Loading />}><Welcome key={1} /></Suspense>,
  },
  {
    path: "/report-error",
    element: <Suspense fallback={<Loading />}><ReportBug /></Suspense>,
  ...
  },
  {
    ...
    element: <Suspense fallback={<Loading />}><RemindPassword /></Suspense>,
  ...
  {
    path: "/subscriptions",
    element: <Suspense fallback={<Loading />}><Offer /></Suspense>,
  ...
  },
  {
    ...
    children: [
      {
        path: "help",
        element: <Suspense fallback={<Loading />}><UserHelp /></Suspense>,
      },
      {
        path: "report-error",
        element: <Suspense fallback={<Loading />}><UserReportBug /></Suspense>,
      },
      {
        path: "account",
        ...
        children: [
          {
            path: 'data',
            element: <Suspense fallback={<Loading />}><UserData /></Suspense>,
          ...
          {
            path: 'subscriptions',
            element: <Suspense fallback={<Loading />}><Subscriptions /></Suspense>,
      ...
      {
        path: "tests",
        element: <Suspense fallback={<Loading />}><Tests /></Suspense>,
        children: [
          {
            path: "create",
            element: <Suspense fallback={<Loading />}><CreateTestInstance title /></Suspense>,
            loader: createTestLoader,
            action: createTestAction,
          },
          {
            path: "settings",
            element: <Suspense fallback={<Loading />}><TestsSettings /></Suspense>,
            children: [
              {
                path: "new",
              ...
              {
                path: "delete",
                element: <Suspense fallback={<Loading />}><Delete /></Suspense>,
              },
              {
                path:'newest',
                element: <Suspense fallback={<Loading />}><AfterCreation /></Suspense>,
          ...
          },
          {
            ...
            children: [
              {
                path: ":testId",
                element: <Suspense fallback={<Loading />}><TestStatistics /></Suspense>,
                loader: getTestStatistics,
                children: [
                  {
                    path: "question/:questionId?",
                    element: <Suspense fallback={<Loading />}><QuestionStatistics /></Suspense>,
                    loader: async ({ params }) => ({
          ...
          },
          {
              ...
              path: 'flashcards',
              element: <Suspense fallback={<Loading />}><FlashcardsSetting /></Suspense>,
              loader: flashcardsSettingLoader,
              action: flashcardsAction,
              children: [
                {
                  path: 'start',
                  element: <Suspense fallback={<Loading />}><Flashcards /></Suspense>,
                }
              ]
          }
        ],
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              {
                path: ":team",
                element: <Suspense fallback={<Loading />}><AfterUserChoseTeam /></Suspense>,
                loader: teamLoader,
              },
            ],
          },
          {
            path: "handbook",
            element: <Suspense fallback={<Loading />}><Handbook /></Suspense>,
            loader: teamsLoader,
            children: [
              {
                path: "team/:team",
                element: <Suspense fallback={<Loading />}><ModifyHandbooks /></Suspense>,
          ...
          {
            path: "egzam",
            element: <Suspense fallback={<Loading />}><MakeEgzam /></Suspense>,
            loader: teamsLoader,
            children: [
              {
                path: "teams/:teamId",
                element: <Suspense fallback={<Loading />}><ChooseEgzamSettings /></Suspense>,
                loader: createTestLoader,
          ...
          },
          {
            ...
            element: <Suspense fallback={<Loading />}><CreateOpenQuestion/></Suspense>,
            action: createOpenQuestionAction
          },
          {
            path:'delete',
            element:<Suspense fallback={<Loading />}> <DeleteTeam /></Suspense>,
            loader:teamsLoader
          },
          {
            path: "egzams",
            element: <Suspense fallback={<Loading />}><ChooseTeam/></Suspense>,
            loader: teamsLoader,
            children: [
              {
                path: 'teams/:teamId',
                element: <Suspense fallback={<Loading />}><Egzams /></Suspense>,
                loader: getEgzamsLoader,
                children: [
                  {
                    path: 'egzams/:testId',
                    element: <Suspense fallback={<Loading />}><ShowTestResults /></Suspense>,
...

      {
        ...
        element: <Suspense fallback={<Loading />}><SolveTest /></Suspense>,
        loader: solveTestLoader,
        action: sendFilledTestAction,
        children: [
          {
            path: "review",
            element:<Suspense fallback={<Loading />}> <TestReview /></Suspense>,
...

      {
        ...
        element:<Suspense fallback={<Loading />}> <TestSummary /></Suspense>,
      ...
      {
        path:'notyfications',
        element: <Suspense fallback={<Loading />}><Notyfications /></Suspense>,
        loader: notyficationsLoader
      },
      {
        path: 'check/tests/:id/open-questions',
        element: <Suspense fallback={<Loading />}><OpenQuestionCheck /></Suspense>,
      ...
      children: [
        {
          path:'subscriptions',
          element: <Suspense fallback={<Loading />}><AdminSubscriptions /></Suspense>,
          action: createSubscriptionAction,
          loader: getAdminSubscriptionsLoader,
          children: [
             {
          path:':subscription',
          element: <Suspense fallback={<Loading />}><UpdateAndDeleteSubscription /></Suspense>,
        ...
        {
        path: 'tests',
        element: <Suspense fallback={<Loading />}><ManageTests /></Suspense>,
        loader: adminTestLoader,
        action: createAdminTest,
        children: [
          {
            path: 'settings/:testId',
            element: <Suspense fallback={<Loading />}><AdminTestSettings /></Suspense>,
        ...
        },
        {
          ...
          children: [
            ...
            {
              path: 'delete',
              element: <Suspense fallback={<Loading />}><DeleteCategory /></Suspense>,
        ...
        {
          path: 'flashcards',
          element: <Suspense fallback={<Loading />}><AdminFlashcards /></Suspense>,
          children: [
            {path: 'new',
          ...
          {path: 'delete',
            element: <Suspense fallback={<Loading />}><DeleteFlashcards /></Suspense>,
            loader: getAdminSubscriptionsLoader,
        ...
        {
          path: 'mail',
          element: <Suspense fallback={<Loading />}><Mail /></Suspense>,
